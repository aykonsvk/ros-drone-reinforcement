...
from task_env.x_y_line_follow import XYLineFollowEnv
import gym
import numpy as np
...
rospy.init_node('y_deepq', anonymous=True, log_level=rospy.ERROR)

tf.keras.backend.set_floatx('float64')
wandb.init(name='DQN', project="deep-rl-xy")
...
outdir = pkg_path + '/training_results/deepq/x_y'
...
def main():
    env = gym.make('XYLineFollowEnv-v0')
    agent = Agent(env)
