...
class XYZLineFollowEnv(drone_env.DroneEnv):
    ...
    def __init__(self):
        ...
        super(XYZLineFollowEnv, self).__init__()
    ...
    def _compute_reward(self, observations, done):
        ...
        if not done:
            ...
            if self.x_is_ideal_from_cable(current_position):
                reward = reward + self.x_distance_reward
            else:
                reward = reward + self.x_distance_punishment

            if self.z_is_ideal_from_cable(current_position):
    ...
    def x_is_ideal_from_cable(self, coordinates):
    ...
    def z_is_ideal_from_cable(self, coordinates):
        ...
        # I did simple calculation instead cable is at z=3 (arbitrary picked)
